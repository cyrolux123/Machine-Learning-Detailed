...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"c:/ML Nabin/venv/python.exe",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"C:/b/abs_853rfy8zse/croot/contourpy_1700583617587/work/.mesonpy-v8jsunqs/build/lib/contourpy/util",
        source_dir=r"C:/b/abs_853rfy8zse/croot/contourpy_1700583617587/work/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True '--native-file=C:/b/abs_853rfy8zse/croot/contourpy_1700583617587/work/.mesonpy-v8jsunqs/build/meson-python-native-file.ini'",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
